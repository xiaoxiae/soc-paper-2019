...
\begin{document}
  ...
  \begin{table}[H]
    \caption[Funkčnost stránky na různých platformách]{Funkčnost stránky na různých platformách. Správné fungování je značeno symbolem \faIcon{check}, špatné symbolem \faIcon{times} a nemožnost testování z důvodu nedostupnosti prohlížeče na dané platformě je značeno symbolem \faIcon{minus}.}
