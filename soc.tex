...
\setlength{\cftfigindent}{0pt}                  % lof indentation
\setlength{\cfttabindent}{0pt}                  % lot indentation
...
\DeclareFieldFormat{labelnumberwidth}{[#1]}     % wrap references in square br.
...
\usepackage[font=small, labelfont=bf, figurename=Obr., tablename=Tab.]{caption}
...
% the space between the number and the text of the title is 1em = 10pt
