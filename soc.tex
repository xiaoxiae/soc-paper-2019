...
\begin{document}
  ...
  Celková návštěvnost stránky v období od 18. prosince 2018 (počátek měření) k 18. března 2018 činí \emph{466} návštěvníků. Jejich demografické údaje zachycují grafy \ref{img:Pohlaví návštěvníků stránky} a \ref{img:Věk návštěvníků stránky}.
  ...
  Údaje o přístupu ke stránce jsou dále zaneseny do tabulek \ref{tab:Návštěvnost stránky podle země} a \ref{tab:Návštěvnost stránky podle prohlížeče}.
