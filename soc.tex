...
\begin{document}
  ...
  Funkčnost různých komponent stránky byla testována na několika z nejpoužívanějších prolížečů internetu~\cite{browser-statistics}: Firefox 65.0.1 (\faIcon{firefox}), Chrome ... (\faIcon{chrome}), Internet Explorer ... (\faIcon{internet-explorer}), Edge ... (\faIcon{edge}), Safari ... (\faIcon{safari}) a Opera ... (\faIcon{opera}). Testování se skládalo z načtení stránky na příslušném prohlížeči a kontrolování, zda testované komponenty fungují správně.
